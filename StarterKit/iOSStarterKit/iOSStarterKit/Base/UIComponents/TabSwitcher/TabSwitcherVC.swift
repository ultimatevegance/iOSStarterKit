...
public enum TabSwitcherButtonBarItemSpec<CellType: UICollectionViewCell> {
...
public struct TabSwitcherSettings {
    ...
    public struct Style {
        ...
        public var selectedBarBackgroundColor = AppColor.appThemeColor
        public var selectedBarHeight: CGFloat = 3.5
        public var selectedBarVerticalAlignment: SelectedBarVerticalAlignment = .bottom
        public var selectedBarStyle: SelectedBarStyle = .autoWidth
        public var selectedBarWidth: CGFloat = 30.0
...
open class TabSwitcherVC: PagerTabStripViewController, PagerTabStripDataSource, PagerTabStripIsProgressiveDelegate, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    open override func viewDidLoad() {
        ...
        let bundle = Bundle(for: ButtonBarViewCell.self)
        ...
        let buttonBarViewAux = buttonBarView ?? {
            ...
            buttonBar.selectedBar.backgroundColor = AppColor.appThemeColor
            buttonBar.selectedBarWidth = settings.style.selectedBarWidth
        ...
        buttonBarView.selectedBarStyle = settings.style.selectedBarStyle
